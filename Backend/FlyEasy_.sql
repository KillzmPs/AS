...
--
-- Host: localhost:3306
-- Tempo de geração: 14-Maio-2025 às 10:52
...
(22, 'Kabul International Airport', 'Kabul', 1);
...
(2, 5, '2025-05-01 14:06:03'),
(3, 1, '2025-05-01 14:13:39'),
(58, 19, '2025-05-07 16:17:46'),
(59, 19, '2025-05-07 16:18:18'),
(60, 19, '2025-05-07 16:19:20'),
(61, 19, '2025-05-07 16:19:40'),
(62, 19, '2025-05-07 16:21:05'),
(63, 19, '2025-05-07 16:21:44'),
(64, 19, '2025-05-07 16:22:05'),
(65, 19, '2025-05-07 16:22:06'),
(66, 1, '2025-05-14 09:57:28'),
(67, 1, '2025-05-14 10:03:14'),
(68, 1, '2025-05-14 10:09:16');
...
(1, 4, '2025-05-24', '2025-08-20'),
(3, 13, '2025-07-19', '2025-08-01'),
(3, 15, '2025-07-19', '2025-08-01'),
(3, 17, '2025-07-19', '2025-08-01'),
(58, 71, '2025-08-20', '2025-08-20'),
(59, 71, '2025-08-20', '2025-08-20'),
(60, 71, '2025-08-20', '2025-08-20'),
(61, 71, '2025-08-20', '2025-08-20'),
(62, 71, '2025-08-20', '2025-08-20'),
(63, 71, '2025-08-20', '2025-08-20'),
(64, 71, '2025-08-20', '2025-08-20'),
(65, 71, '2025-08-20', '2025-08-20'),
(66, 74, '2025-08-20', '2025-08-20'),
(67, 75, '2025-05-24', '2025-08-20');
...
INSERT INTO `Estado` (`Id`, `Tipo_Estado`, `Cor`) VALUES
(1, 'Aguardar Pagamento', 'yellow'),
(2, 'Pago', 'green'),
(3, 'Cancelada', 'red'),
(4, 'Expirada', 'gray'),
(5, 'A Aguardar Resposta', 'yellow'),
(6, 'Resolvido', 'green');
...
(2, 2, 400.00, '2024-05-01 14:07:04', 1, 2),
(3, 3, 1500.00, '2025-05-15 14:27:19', 3, 1),
(22, 58, 35597.40, NULL, 1, 2),
(23, 59, 35597.40, NULL, 1, 2),
(24, 60, 35597.40, NULL, 1, 2),
(25, 61, 35597.40, NULL, 1, 1),
(26, 62, 35597.40, NULL, 1, 1),
(27, 63, 35597.40, NULL, 1, 1),
(28, 66, 64240.00, NULL, 1, 1),
(29, 67, 66397.40, NULL, 1, 1),
(30, 68, 1000.00, NULL, 1, 1);
...
CREATE TABLE `Utilizador` (
  ...
  `Id_Pais` int NOT NULL,
  `Id_Tipo_Utilizador` int NOT NULL DEFAULT '2',
...
INSERT INTO `Utilizador` (`Id`, `Nome`, `Email`, `Telemovel`, `Data_Aniversario`, `Palavra_passe`, `Id_Pais`, `Id_Tipo_Utilizador`, `Ativo_2FA`) VALUES
(1, 'Henrique Malzaver', 'henriquemalzaver@ua.pt', 987654321, '2004-01-01', '$2b$10$4MwpzlCBwyx21wXIpvFqbO4LlQTn6g63qINVDBPZFF/92.7pXqD6q', 142, 2, 1),
(2, 'Developer', 'developer@flyeasy.pt', 987879678, '1990-01-01', '$2b$10$YRHghpxNk8tckqN9vf1Ecu6dMJalUhav.WbwfYVznMOt62NQIiMfy', 142, 1, 0),
(5, 'Gulherme Tavares', 'gftavares@gmail.com', 987654321, '2005-11-23', '$2b$10$FNY8z68TO5UxfO7vWFdV7uYmhL9iR2RZxSSoK4LoELb7GnrmY6zcO', 142, 2, 0),
(16, 'Angelino Cauchie', 'angelocauchie@ua.pt', 98754321, '1111-11-11', '$2b$10$9U1uvLWxu1wkbStdtc8P1OPkpZH0FcmZCB7OXkYeeX7hYoBzaf5tq', 13, 2, 0),
(17, 'tomas', 'tomas.santos.cruz@ua.pt', 988888888, '2005-03-01', '$2b$10$.t0RcyBoeo2GWJ5c6zrZD.YVzxvez69Rt0YZngszchUpEACOiKSYi', 170, 2, 1),
(18, 'Lindo', 'afonsocoelho@ua.pt', 919553146, '2006-06-08', '$2b$10$Wqrvz1RlgErhE3ng6yGjHexEBhkGU.O0nnBcDkV7qnNpGrTgovi6m', 1, 2, 0),
(19, 'Pedrinho', 'pedronpmonteiro@ua.pt', 987654321, '2011-11-11', '$2b$10$7oRQLVtqkxaTyDlm8aCwKutfV7bczRO8Ngmfi8ZapBR4ztRpaDoHi', 14, 2, 0);
...
(3, 1, 6, 1, '2025-05-24 06:00:00', '2025-05-24 07:15:00', 198.80, 150, 1),
...
(54, 1, 22, 10, '2025-05-08 13:46:34', '2025-05-08 20:46:34', 300.00, 400, 1),
(55, 22, 1, 1, '2025-05-09 13:47:30', '2025-05-09 20:47:30', 500.00, 300, 1),
(56, 1, 6, 4, '2025-05-24 09:52:35', '2025-05-24 12:52:35', 340.00, 140, 1),
(57, 6, 1, 8, '2025-08-20 09:52:35', '2025-08-20 12:52:35', 540.00, 130, 1),
(58, 12, 9, 9, '2025-05-15 10:05:31', '2025-05-14 11:05:31', 1000.00, 150, 2);
